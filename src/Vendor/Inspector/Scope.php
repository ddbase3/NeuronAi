...
class Scope implements SegmentStack
{
     ...
     * @throws Throwable
     */
    public function addSegment(callable $callback, string $type, ?string $label = null, bool $throw = \true): mixed
    {
    ...
    {
        return array_map(fn(Segment $segment): array => ['type' => $segment->type, 'label' => $segment->label, 'hash' => $segment->getHash()], $this->openSegments);
    }
    /**
