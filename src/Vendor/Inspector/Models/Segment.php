...
use NeuronAi\Vendor\Inspector\SegmentStack;
use function hash;
...
class Segment extends PerformanceModel
{
     ...
     * Span constructor.
     */
    public function __construct(Transaction $transaction, public string $type = 'process', public ?string $label = null)
    {
        $this->host = new Host();
    ...
    {
        $initial = $timestamp ?? microtime(\true);
    ...
    {
        return hash('sha256', $this->type . $this->label . microtime(\true) . random_int(100, 9999));
    }
    /**
