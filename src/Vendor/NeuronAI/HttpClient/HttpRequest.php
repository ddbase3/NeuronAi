...
class HttpRequest
{
     ...
     */
    public function __construct(public HttpMethod $method, public string $uri, public array $headers = [], public array|string|null $body = null)
    {
        if (strpbrk($this->uri, "\r\n") !== \false) {
    ...
    {
        return new self($this->method, $this->uri, [...$this->headers, ...$headers], $this->body);
    }
}
