...
{
    public function __construct(protected readonly string $evaluatorClass, protected readonly string $assertionMethod, protected readonly string $message, protected readonly int $lineNumber, protected readonly array $context = [])
    {
    }
    ...
    {
        return sprintf('%s:%d -> %s: %s', $this->getShortEvaluatorClass(), $this->lineNumber, $this->assertionMethod, $this->message);
    }
    /**
