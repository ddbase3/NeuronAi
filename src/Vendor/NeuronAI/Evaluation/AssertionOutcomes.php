...
class AssertionOutcomes
{
     ...
     */
    public function __construct(public readonly int $passedCount, public readonly int $failedCount, public readonly array $failures = [], public readonly array $scores = [])
    {
    }
    /**
