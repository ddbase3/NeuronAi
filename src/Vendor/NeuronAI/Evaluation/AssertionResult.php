...
{
    public function __construct(public readonly bool $passed, public readonly float $score, public readonly string $message, public readonly array $context = [])
    {
    }
    /**
    ...
    {
        return new self(\true, $score, $message, $context);
    }
    /**
