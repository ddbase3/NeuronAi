...
abstract class BaseEvaluator implements EvaluatorInterface
{
    ...
    final public function performEvaluation(mixed $output, array $datasetItem): AssertionOutcomes
    {
        ...
        return new AssertionOutcomes($this->ruleExecutor->getPassedCount(), $this->ruleExecutor->getFailedCount(), $this->ruleExecutor->getFailures(), $this->ruleExecutor->getScores());
    }
    /**
