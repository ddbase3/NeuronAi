...
namespace NeuronAi\Vendor\NeuronAI\Evaluation\Config;
...
class EvaluationOutputResolver
{
    ...
    public function __construct(protected readonly EvaluationOutputFactory $factory = new EvaluationOutputFactory())
    {
    }
    /**
