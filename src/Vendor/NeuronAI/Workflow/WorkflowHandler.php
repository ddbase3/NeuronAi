...
class WorkflowHandler implements WorkflowHandlerInterface
{
    ...
    public function __construct(protected Workflow $workflow, protected ?InterruptRequest $resumeRequest = null)
    {
    }
    /**
    ...
    public function events(?StreamAdapterInterface $adapter = null): Generator
    {
        ...
        // Stream events
        $generator = $this->resumeRequest instanceof InterruptRequest ? $this->workflow->resume($this->resumeRequest) : $this->workflow->run();
