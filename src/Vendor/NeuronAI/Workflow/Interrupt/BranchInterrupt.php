...
{
    public function __construct(public readonly string $branchId, public readonly WorkflowInterrupt $original)
    {
        parent::__construct("WorkflowInterrupt in branch '{$branchId}': " . $original->getMessage(), 0, $original);
    }
}
