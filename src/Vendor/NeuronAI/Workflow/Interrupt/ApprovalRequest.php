...
class ApprovalRequest extends InterruptRequest
{
    ...
    {
        return ['message' => $this->message, 'actions' => json_encode(array_values($this->actions))];
    }
    /**
    ...
    public static function fromArray(array $data): self
    {
        ...
        $actionsData = is_array($data['actions']) ? $data['actions'] : json_decode((string) $data['actions'], \true);
