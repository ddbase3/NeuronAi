...
class Action implements JsonSerializable
{
     ...
     */
    public function __construct(public readonly string $id, public readonly string $name, public readonly ?string $description = null, public ActionDecision $decision = ActionDecision::Pending, public ?string $feedback = null)
    {
    }
    ...
    {
        return ['id' => $this->id, 'name' => $this->name, 'description' => $this->description, 'decision' => $this->decision->value, 'feedback' => $this->feedback];
    }
    /**
     * Create from array.
     *
    ...
    {
        return new self($data['id'], $data['name'], $data['description'] ?? null, ActionDecision::from($data['decision']), $data['feedback'] ?? null);
    }
}
