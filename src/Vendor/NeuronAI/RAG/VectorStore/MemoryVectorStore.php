...
class MemoryVectorStore implements VectorStoreInterface
{
    ...
    {
        $this->documents = array_filter($this->documents, fn(Document $document): bool => $document->getSourceType() !== $sourceType || $sourceName !== null && $document->getSourceName() !== $sourceName);
        return $this;
    }
    /**
    ...
    public function similaritySearch(array $embedding): array
    {
        ...
        $topKIndices = array_slice(array_keys($distances), 0, $this->topK, \true);
