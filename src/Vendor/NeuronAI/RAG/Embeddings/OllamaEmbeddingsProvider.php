...
{
    use HasHttpClient;
    public function __construct(protected string $model, protected string $url = 'http://localhost:11434/api', protected array $parameters = [], ?HttpClientInterface $httpClient = null)
    {
    ...
    {
        $response = $this->httpClient->request(HttpRequest::post(uri: 'embed', body: ['model' => $this->model, 'input' => $text, ...$this->parameters]))->json();
