...
use NeuronAi\Vendor\NeuronAI\StructuredOutput\StructuredOutputException;
use Attribute;
use BackedEnum;
...
class Enum extends AbstractValidationRule
{
     ...
     */
    public function __construct(protected ?array $values = [], protected ?string $class = null, protected bool $nullable = \false)
    {
