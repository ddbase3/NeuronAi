...
namespace NeuronAi\Vendor\NeuronAI\StructuredOutput\Validation\Rules;
...
class ArrayOf extends AbstractValidationRule
{
    ...
    private const VALIDATION_FUNCTIONS = ['boolean' => 'is_bool', 'integer' => 'is_int', 'float' => 'is_float', 'numeric' => 'is_numeric', 'string' => 'is_string', 'scalar' => 'is_scalar', 'array' => 'is_array', 'iterable' => 'is_iterable', 'countable' => 'is_countable', 'object' => 'is_object', 'null' => 'is_null', 'alnum' => 'ctype_alnum', 'alpha' => 'ctype_alpha', 'cntrl' => 'ctype_cntrl', 'digit' => 'ctype_digit', 'graph' => 'ctype_graph', 'lower' => 'ctype_lower', 'print' => 'ctype_print', 'punct' => 'ctype_punct', 'space' => 'ctype_space', 'upper' => 'ctype_upper', 'xdigit' => 'ctype_xdigit'];
    public function __construct(string|array $type, protected bool $allowEmpty = \false)
    {
