...
class JinaUrlReader extends Tool
{
    ...
    {
        return $this->client ?? $this->client = new Client(['headers' => ['Authorization' => 'Bearer ' . $this->key, 'Content-Type' => 'application/json', 'Accept' => 'application/json', 'X-Return-Format' => 'Markdown']]);
    }
    public function __invoke(string $url): string
    {
        ...
        $response = $this->getClient()->post('https://r.jina.ai/', [RequestOptions::JSON => ['url' => $url]]);
