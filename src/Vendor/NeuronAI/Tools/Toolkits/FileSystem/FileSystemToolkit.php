...
class FileSystemToolkit extends AbstractToolkit
{
    ...
    {
        return [ReadFileTool::make(), GrepFileContentTool::make(), GlobPathTool::make(), ParseFileTool::make(), WriteFileTool::make(), DeleteFileTool::make(), EditFileTool::make(), BashTool::make()];
    }
}
