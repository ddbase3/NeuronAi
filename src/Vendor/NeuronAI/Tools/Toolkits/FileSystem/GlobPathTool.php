...
class GlobPathTool extends Tool
{
    ...
    {
        parent::__construct(name: 'glob_path', description: 'Find files matching a glob pattern in a directory.');
    }
    protected function properties(): array
    {
        return [ToolProperty::make(name: 'directory', type: PropertyType::STRING, description: 'Path to the directory to search in.'), ToolProperty::make(name: 'pattern', type: PropertyType::STRING, description: 'Glob pattern to match (e.g., "*.php", "**/*.pdf", "**/*.md").')];
    }
