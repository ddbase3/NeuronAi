...
{
    public function __construct(protected int $precision = 2, protected bool $sample = \true)
    {
        parent::__construct('calculate_standard_deviation', <<<DESC
...
DESC
    ...
    {
        return [new ArrayProperty(name: 'numbers', description: 'Array of numerical values', required: \true, items: new ToolProperty('number', PropertyType::NUMBER, 'A numerical value', \true))];
    }
