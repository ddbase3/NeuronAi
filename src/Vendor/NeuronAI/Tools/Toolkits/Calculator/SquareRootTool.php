...
class SquareRootTool extends Tool
{
    ...
    {
        parent::__construct(name: 'calculate_square_root', description: <<<DESC
...
DESC
    ...
    {
        return [new ToolProperty(name: 'number', type: PropertyType::NUMBER, description: 'The positive number to calculate the square root of', required: \true)];
    }
