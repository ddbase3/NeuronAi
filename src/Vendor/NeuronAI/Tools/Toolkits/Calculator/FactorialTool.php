...
class FactorialTool extends Tool
{
    ...
    {
        parent::__construct('calculate_factorial', <<<DESC
...
DESC
    ...
    {
        return [new ToolProperty(name: 'number', type: PropertyType::INTEGER, description: 'The non-negative integer to calculate the factorial of (must be ≥ 0)', required: \true)];
    }
