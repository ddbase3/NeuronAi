...
class NthRootTool extends Tool
{
    ...
    {
        parent::__construct('calculate_nth_root', <<<DESC
...
DESC
    ...
    {
        return [new ToolProperty(name: 'number', type: PropertyType::NUMBER, description: 'The number to calculate the nth root of', required: \true), new ToolProperty(name: 'root_degree', type: PropertyType::INTEGER, description: 'The degree of the root (e.g., 2 for square root, 3 for cube root, 4 for fourth root, etc.). Must be a positive number.', required: \true)];
    }
