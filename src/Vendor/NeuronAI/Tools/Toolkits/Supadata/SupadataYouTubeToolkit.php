...
GUIDELINES;
    ...
    {
        return [SupadataVideoMetadataTool::make($this->key), SupadataVideoTranscriptTool::make($this->key), SupadataYoutubeChannelTool::make($this->key), SupadataYoutubePlaylistTool::make($this->key)];
    }
}
