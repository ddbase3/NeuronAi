...
use NeuronAi\Vendor\NeuronAI\Exceptions\MissingCallbackParameter;
use NeuronAi\Vendor\NeuronAI\Exceptions\ToolCallableNotSet;
...
class Tool implements ToolInterface
{
     ...
     */
    public function __construct(protected string $name, protected ?string $description = null, protected array $properties = [], protected array $parameters = [], protected array $annotations = [])
    {
    }
    ...
    {
        return ['callId' => $this->callId, 'name' => $this->name, 'description' => $this->description, 'parameters' => $this->parameters, 'inputs' => $this->inputs === [] ? new stdClass() : $this->inputs, 'result' => $this->result];
    }
}
