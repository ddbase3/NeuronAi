...
PROMPT;
     ...
     */
    public function __construct(protected array $toolPool, protected int $topN = 10, protected string $systemPrompt = self::DEFAULT_SYSTEM_PROMPT)
    {
    ...
    public function after(NodeInterface $node, Event $result, WorkflowState $state): void
    {
        ...
        foreach ($discovered as $tool) {
            if (!in_array($tool->getName(), $existingNames, \true)) {
                $result->tools[] = $tool;
