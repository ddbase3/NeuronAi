...
namespace NeuronAi\Vendor\NeuronAI\Providers\HuggingFace;
...
class HuggingFace extends OpenAI
{
     ...
     */
    public function __construct(protected string $key, protected string $model, protected ?InferenceProvider $inferenceProvider = InferenceProvider::HF_INFERENCE, protected bool $strict_response = \false, protected array $parameters = [], ?HttpClientInterface $httpClient = null)
    {
        $this->buildBaseUri();
