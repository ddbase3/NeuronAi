...
namespace NeuronAi\Vendor\NeuronAI\Providers\Alibaba;
...
{
    public function __construct(protected string $key, protected string $model, protected array $parameters = [], protected bool $strict_response = \false, ?HttpClientInterface $httpClient = null, protected string $baseUri = 'https://dashscope.aliyuncs.com/compatible-mode/v1')
    {
