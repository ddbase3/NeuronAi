...
trait HandleStructured
{
    ...
    public function structured(array|Message $messages, string $class, array $response_format): Message
    {
        ...
        try {
            $this->system .= PHP_EOL . "<output-contraints>" . PHP_EOL . "Your response should be a JSON string following this schema: " . PHP_EOL . json_encode($response_format) . PHP_EOL . "</output-contraints>";
