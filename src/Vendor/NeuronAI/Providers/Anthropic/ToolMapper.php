...
class ToolMapper implements ToolMapperInterface
{
    ...
    protected function mapTool(ToolInterface $tool): array
    {
        ...
        $payload = ['name' => $tool->getName(), 'description' => $tool->getDescription(), 'input_schema' => ['type' => 'object', 'properties' => empty($properties) ? null : $properties, 'required' => $tool->getRequiredProperties()]];
