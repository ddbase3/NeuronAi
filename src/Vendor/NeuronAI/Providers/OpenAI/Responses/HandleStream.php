...
trait HandleStream
{
    ...
    {
        $body = ['stream' => \true, 'model' => $this->model, 'input' => $this->messageMapper()->map($messages), ...$this->parameters];
        ...
        $stream = $this->httpClient->stream(HttpRequest::post(uri: 'responses', body: $body));
    ...
    protected function parseNextDataLine(StreamInterface $stream): ?array
    {
        ...
        try {
            $event = json_decode($line, \true, flags: JSON_THROW_ON_ERROR);
