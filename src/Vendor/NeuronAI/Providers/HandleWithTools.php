...
trait HandleWithTools
{
    ...
    public function findTool(string $name): ToolInterface
    {
        ...
        throw new ProviderException("The model is asking for a non-existing tool: {$name}. You could try writing more verbose tool descriptions and prompts to help the model in the task.");
    }
}
