...
class ToolCallMessage extends AssistantMessage implements Stringable
{
     ...
     */
    public function __construct(string|ContentBlockInterface|array|null $content = null, protected array $tools = [])
    {
    ...
    {
        return array_merge(parent::jsonSerialize(), ['type' => 'tool_call', 'tools' => array_map(fn(ToolInterface $tool): array => $tool->jsonSerialize(), $this->tools)]);
    }
