...
{
    public function __construct(protected string $directory, protected string $key, int $contextWindow = 50000, protected string $prefix = 'neuron_', protected string $ext = '.chat')
    {
    ...
    protected function load(): void
    {
        if (is_file($this->getFilePath())) {
            $messages = json_decode(file_get_contents($this->getFilePath()), \true) ?? [];
