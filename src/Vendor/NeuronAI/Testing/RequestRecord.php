...
class RequestRecord
{
     ...
     */
    public function __construct(public readonly string $method, public readonly array $messages, public readonly ?string $systemPrompt, public readonly array $tools, public readonly ?string $structuredClass = null, public readonly array $structuredSchema = [])
    {
    }
}
